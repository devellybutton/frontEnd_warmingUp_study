const menu = [
  ...
  },
  {
    ...
    onlyNaver: false,
    desc: "믿고 먹는 누텔라<br> 초코베이글 + 크림치즈 + 누텔라 + 카카오가루토핑",
  },
  {
    id: 3,
    ...
    onlyNaver: false,
    desc: "싱가폴보다 맛있는 카야<br> 어니언베이글 + 크림치즈 + 카야잼 + 그래놀라",
  },
  {
    id: 4,
    ...
    onlyNaver: false,
    desc: "잊고 싶어도 자꾸 생각나는 초베<br> 블루베리 베이글 + 크림치즈 + 블루베리잼 + 초코그래놀라",
  },
  {
    id: 5,
    title: "딸기 쿠키 크랜베리베이글",
    ...
    onlyNaver: false,
    desc: "돼지바의 베이글 버전?!?<br> 크랜베리 베이글 + 크림치즈 + 딸기잼 + 쿠키분태",
  },
  {
    id: 6,
    ...
    onlyNaver: false,
    desc: "사과가 큼직해서 깜놀<br> 모짜렐라 베이글 + 크림치즈 + 애플시나몬잼 + 시나몬가루",
  },
  /* 샌드위치 */
  {
    id: 7,
